...
class AddIterationStrategyEdit extends EditSupport<IterationStrategyStack> {
	...
	public IterationStrategyStack applyEdit() throws EditException {
		iterationStrategyStack.addStrategy(iterationStrategy);

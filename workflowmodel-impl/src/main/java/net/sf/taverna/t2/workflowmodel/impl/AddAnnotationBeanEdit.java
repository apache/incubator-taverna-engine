...
class AddAnnotationBeanEdit extends EditSupport<AnnotationAssertion<AnnotationBeanSPI>> {
	...
	@Override
	public AnnotationAssertion<AnnotationBeanSPI> applyEdit() throws EditException {
		synchronized (annotationAssertion) {
			annotationAssertion.setAnnotationBean(annotationBean);
